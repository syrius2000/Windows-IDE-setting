...
| **rig** | R言語バージョンマネージャー | MIT | [github.com/r-lib/rig](https://github.com/r-lib/rig) | Win/Mac | `winget install RProject.rig` / `brew install rig` | 0.7+ | `rig self update` | `winget uninstall RProject.rig` | **必須** | Rの複数版管理・Rtools連携 |
